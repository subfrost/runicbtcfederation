...
class AddressReceivedAmount$Type extends runtime_4.MessageType {
    ...
    internalBinaryWrite(message, writer, options) {
        ...
        if (message.senderAddress !== "")
            writer.tag(1, runtime_1.WireType.LengthDelimited).string(message.senderAddress);
        /* bytes amount = 2; */
...
class PaymentResponse$Type extends runtime_4.MessageType {
    constructor() {
        super("protorune.PaymentResponse", [
        ...
        while (reader.pos < end) {
            ...
            switch (fieldNo) {
                case /* bytes recipient */ 1:
                    message.recipient = reader.bytes();
                    break;
                case /* repeated protorune.SenderAddress senders */ 2:
    ...
    internalBinaryWrite(message, writer, options) {
        ...
        /* repeated protorune.SenderAddress senders = 2; */
